...
(function(){
  var ref$, empty, map, fold1, keys, values, first, flatten, h, net, Backbone, subscriptionMan, colors, UdpGun, os, util, _, index, exports, db, Console, Fluent, Udp, Tcp, tcpServer;
