...
(function(){
  var ref$, map, fold1, keys, first, h, Backbone, subscriptionMan, callable, colors, UdpGun, os, _, util, throwError, ignoreError, Logger, parseArray, Console, Udp, slice$ = [].slice;
