...
(function(){
  var ref$, map, fold1, keys, h, Backbone, subscriptionMan, colors, UdpGun, os, throwError, ignoreError, Logger, Data, Console, Udp, slice$ = [].slice;
  ref$ = require('prelude-ls'), map = ref$.map, fold1 = ref$.fold1, keys = ref$.keys;
  h = require('helpers');
  ...
  Console = exports.Console = Backbone.Model.extend4000({
    ...
    parseTags: function(tags){
      return map(tags, function(bla, tag){
    ...
    log: function(logEvent){
      ...
      tags = this.parseTags(keys(logEvent.tags));
