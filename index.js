...
(function(){
  var ref$, map, fold1, keys, first, h, Backbone, subscriptionMan, colors, UdpGun, os, _, util, throwError, ignoreError, callable, Logger, parseArray, Console, Udp, slice$ = [].slice;
  ref$ = require('prelude-ls'), map = ref$.map, fold1 = ref$.fold1, keys = ref$.keys, first = ref$.first;
  h = require('helpers');
