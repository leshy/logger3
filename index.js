...
(function(){
  var ref$, map, fold1, keys, first, flatten, h, Backbone, subscriptionMan, colors, UdpGun, os, _, util, throwError, ignoreError, callable, Logger, parseArray, Console, Udp, slice$ = [].slice;
  ref$ = require('prelude-ls'), map = ref$.map, fold1 = ref$.fold1, keys = ref$.keys, first = ref$.first, flatten = ref$.flatten;
  h = require('helpers');
        ...
        return {
          ...
          tags: (function(){
            ...
            case Object:
              return it.tags;
            case Array:
              return compose$(flatten, h.arrayToDict)(it.tags);
            default:
  ...
  Console = exports.Console = Backbone.Model.extend4000({
    ...
    parseTags: function(tags){
      return map(function(tag){
        ...
        if (tag === 'pass' || tag === 'ok' || tag === 'success') {
