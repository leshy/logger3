...
(function(){
  var ref$, map, fold1, keys, values, first, flatten, h, net, Backbone, subscriptionMan, colors, UdpGun, os, _, util, throwError, ignoreError, callable, Logger, parseArray, Console, Udp, tcpServer, slice$ = [].slice;
